...
source=("https://music-desktop-application.s3.yandex.net/stable/Yandex_Music_x64_5.0.20.exe" "git+https://github.com/cucumber-sp/yandex-music-linux")
sha256sums=("561c0c219fe0bf70687aa9eeae45bdfbe71a844bd5987b8d60f5a9d8aedaefda" "SKIP")

build() {
    bash "$srcdir/yandex-music-linux/repack.sh" "$srcdir/Yandex_Music_x64_5.0.20.exe"
}
