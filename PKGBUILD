...
source=("https://music-desktop-application.s3.yandex.net/stable/Yandex_Music_x64_5.30.3.exe" "git+${url}#tag=v${pkgver}")
sha256sums=("b512c54f575562da2300df0648d2b15db94fa45100b72a794875630a35ee1163" "SKIP")

build() {
    bash "$srcdir/yandex-music-linux/repack.sh" "$srcdir/Yandex_Music_x64_5.30.3.exe"
}
